...
export default function EditProperty() {
    ...
    if (initialLoading) {
        return (
            <div className="h-screen w-full flex items-center justify-center bg-[#f5f8f8] dark:bg-[#101822]">
                <div className="flex flex-col items-center gap-4">
                    <div className="h-10 w-10 border-4 border-[#101822]/10 dark:border-white/10 border-t-primary rounded-full animate-spin"></div>
        ...
        <div className="bg-[#f5f8f8] dark:bg-[#101822] font-display min-h-screen text-slate-900 dark:text-slate-100 pb-32">
            ...
            <header className="sticky top-0 z-30 bg-white/80 dark:bg-[#101822]/80 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 py-4 px-6 md:px-12 transition-all">
                <div className="max-w-4xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl md:text-2xl font-black tracking-tight text-[#1E1B4B] dark:text-white uppercase line-clamp-1">Edit Property</h1>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div className="max-w-4xl mx-auto px-6 py-8">
                <div className="flex items-center justify-between relative">
                    ...
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 w-3/4 h-1 bg-primary rounded-full -z-10 shadow-lg shadow-primary/20"></div>

                    <div className="flex flex-col items-center gap-2 cursor-pointer">
                        <div className="size-8 md:size-10 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm shadow-xl shadow-primary/30 border-4 border-[#f5f8f8] dark:border-[#101822]"><span className="material-symbols-outlined text-[16px]">check</span></div>
                        <span className="text-[10px] uppercase font-bold text-primary tracking-widest hidden md:block">Details</span>
                    </div>
                    <div className="flex flex-col items-center gap-2 cursor-pointer">
                        <div className="size-8 md:size-10 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm shadow-xl shadow-primary/30 border-4 border-[#f5f8f8] dark:border-[#101822]"><span className="material-symbols-outlined text-[16px]">check</span></div>
                        <span className="text-[10px] uppercase font-bold text-primary tracking-widest hidden md:block">Photos</span>
                    </div>
                    <div className="flex flex-col items-center gap-2 cursor-pointer">
                        <div className="size-8 md:size-10 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm shadow-xl shadow-primary/30 border-4 border-[#f5f8f8] dark:border-[#101822]">3</div>
                        <span className="text-[10px] uppercase font-bold text-primary tracking-widest hidden md:block">Pricing</span>
                    </div>
            ...
            <main className="max-w-4xl mx-auto px-4 md:px-0">
                <form onSubmit={handleSubmit} className="flex flex-col gap-8 md:gap-12">
                    ...
                    <section className="bg-white dark:bg-[#162725] rounded-[2rem] p-6 md:p-10 shadow-sm border border-slate-100 dark:border-white/5 mb-8">
                        <h2 className="text-xl font-black text-[#1E1B4B] dark:text-white mb-6 flex items-center gap-2 tracking-tight">
                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="w-full border-2 border-dashed border-primary/40 dark:border-primary/30 rounded-[2rem] bg-primary/5 dark:bg-primary/10 p-10 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-primary/10 transition-colors group">
                                    ...
                                    <p className="text-slate-700 dark:text-slate-200 font-bold mb-1">Upload additional high-res imagery</p>
                                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">+ Add More (JPEG or WEBP)</p>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="max-w-4xl mx-auto flex items-center justify-end gap-3 md:gap-4">
                            ...
                            <button type="submit" disabled={loading} className="px-8 md:px-12 py-3.5 md:py-4 bg-gradient-to-tr from-primary to-[#00c9b7] text-[#102221] rounded-full font-black text-sm tracking-widest uppercase shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-transform disabled:opacity-50 disabled:hover:scale-100 flex items-center gap-2">
                                {loading ? (
                                    ...
                                    <>
                                        Save Changes <span className="material-symbols-outlined text-[18px]">publish</span>
                                    </>
                                )}
                            </button>
                        </div>
